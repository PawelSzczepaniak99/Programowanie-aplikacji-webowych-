...
const addNoteButton = <HTMLInputElement> document.querySelector("#buttonAddNote")
const popup = <HTMLInputElement> document.querySelector("#addNewNote")
const submitForm = <HTMLInputElement> document.querySelector("#submitButton")
const tasksID = <HTMLInputElement> document.querySelector('#noteContainer')
const deleteAll = <HTMLInputElement> document.querySelector('#deleteAll')
...
window.onload = function() {
    db.collection("notes").get().then((query) => {
        query.forEach((doc) => {
            ...
            deleteButton.addEventListener("click", (e) => deleteFunction(this.e.target.id))
